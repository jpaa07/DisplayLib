CXXFLAGS=-Wall -O3 -g
OBJECTS=demo-main.o minimal-example.o text-example.o led-image-viewer.o MyDisplay.o
BINARIES=led-matrix minimal-example text-example MyDisplay
...
MyDisplay : MyDisplay.o $(RGB_LIBRARY)
	$(CXX) $(CXXFLAGS) MyDisplay.o -o $@ $(LDFLAGS)
